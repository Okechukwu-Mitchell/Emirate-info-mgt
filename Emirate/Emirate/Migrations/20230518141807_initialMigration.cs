        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TotalCreditLoad = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolFees_Faculty_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchoolFees_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Semester = table.Column<int>(type: "int", nullable: false),
                    CourseInProgress = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentCourses_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCourses_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "StudentSchoolFeesRecords",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SchoolFeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSchoolFeesRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSchoolFeesRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSchoolFeesRecords_SchoolFees_SchoolFeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolFees_FacultyId",
                table: "SchoolFees",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_SchoolFees_LevelId",
                table: "SchoolFees",
                column: "LevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourses_LevelId",
                table: "StudentCourses",
                column: "LevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSchoolFeesRecords_SchoolFeeId",
                table: "StudentSchoolFeesRecords",
                column: "SchoolFeeId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSchoolFeesRecords_UserId",
                table: "StudentSchoolFeesRecords",
                column: "UserId");
        }
